...
#3. Plotting
par(mfrow=c(2,2),pin=c(5,5),pty="m", mar = c(4, 6, 2, 3))
with(partial_data_tbl_2, plot(Date_time, Global_active_power, type = "l", xlab = NA, ylab = "Global Active Power"))
with(partial_data_tbl_2, plot(Date_time, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(partial_data_tbl_2, plot(Date_time, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
